...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  syntax='proto2',
  serialized_pb=_b('\n\rstorage.proto\x1a\x0btypes.proto\"\xe6\x02\n\x07Storage\x12\x0f\n\x07version\x18\x01 \x02(\r\x12\x19\n\x04node\x18\x02 \x01(\x0b\x32\x0b.HDNodeType\x12\x10\n\x08mnemonic\x18\x03 \x01(\t\x12\x1d\n\x15passphrase_protection\x18\x04 \x01(\x08\x12\x1b\n\x13pin_failed_attempts\x18\x05 \x01(\r\x12\x0b\n\x03pin\x18\x06 \x01(\t\x12\x10\n\x08language\x18\x07 \x01(\t\x12\r\n\x05label\x18\x08 \x01(\t\x12\x10\n\x08imported\x18\t \x01(\x08\x12\x12\n\nhomescreen\x18\n \x01(\x0c\x12\x13\n\x0bu2f_counter\x18\x0b \x01(\r\x12\x14\n\x0cneeds_backup\x18\x0c \x01(\x08\x12\r\n\x05\x66lags\x18\r \x01(\r\x12\x1c\n\x07u2froot\x18\x0e \x01(\x0b\x32\x0b.HDNodeType\x12\x19\n\x11unfinished_backup\x18\x0f \x01(\x08\x12\x1a\n\x12\x61uto_lock_delay_ms\x18\x10 \x01(\rB4\n#com.satoshilabs.trezor.lib.protobufB\rTrezorStorage')
  ,
...
_STORAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='needs_backup', full_name='Storage.needs_backup', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flags', full_name='Storage.flags', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='u2froot', full_name='Storage.u2froot', index=13,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unfinished_backup', full_name='Storage.unfinished_backup', index=14,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auto_lock_delay_ms', full_name='Storage.auto_lock_delay_ms', index=15,
...
_STORAGE.fields_by_name['node'].message_type = types__pb2._HDNODETYPE
_STORAGE.fields_by_name['u2froot'].message_type = types__pb2._HDNODETYPE
